...
const askTime = async () => {
    while (true) {
        let answer = await inquirer.prompt({ message: chalk.bgBlue("Tell me your time?"),
            name: "time",
            type: "number",
        });
        ...
        let confirmation = await inquirer.prompt({ message: chalk.bgGreen("do you need more time ?"),
            name: "confirm",
            type: "confirm",
            default: true
        });
